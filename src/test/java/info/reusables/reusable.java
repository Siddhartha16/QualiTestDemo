...
public class reusable implements DriverSource {
	...
	public WebDriver newDriver() {
		...
		String strExecutionPlatform = readProperty(Application_url_property_file, "LOCAL_CHROME");
		String chromeDriverexe = readProperty(Application_url_property_file, "LOCAL_CHROME_DRIVER_PATH");
